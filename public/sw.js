const CACHE='vibemeet-shell-v9';
self.addEventListener('install',e=>{e.waitUntil(caches.open(CACHE).then(c=>c.addAll(['/','/style.css','/app.js','/community.js','/travel.js','/premium.js','/logo.svg','/manifest.webmanifest'])))});
