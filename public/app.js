      ...
      <main class="settingsMain">
        <section class="settingsCard"><div class="settingsHead"><div><span class="settingsIcon">👤</span><div><h2>Account</h2><p>Your sign-in identity and public profile basics.</p></div></div></div>
          <div class="settingsRows">
            <div class="settingsRow"><div><b>Email</b><small>${esc(user.email||'Not available')}</small></div><span class="settingsReadonly">Read only</span></div>
...
window.savePrivacySetting=savePrivacySetting;window.snoozeProfile=snoozeProfile;window.saveTravelModeSetting=saveTravelModeSetting;window.renderSettings=renderSettings;
