...
async function renderHome(){
  ...
  page.innerHTML=`<div class="pagepad discoverPage">
    ...
    <section class="discoverToolbar"><div><span class="eyebrow">DISCOVER</span><h2>Your top picks</h2><p class="muted">Filter by age, city, college, interests or connection mode.</p></div><div class="discoverFilters"><button class="filterPill active">✨ For you</button><button class="secondary" onclick="toggleDiscoverFilterPanel()">⚙ Filters</button><button class="secondary" onclick="render('compatibility')">🧩 Improve score</button></div></section>
