...
const PORT=process.env.PORT||3000;server.listen(PORT,()=>console.log(`VibeMeet running on port ${PORT}`));process.on('SIGTERM',async()=>{await pool.end();process.exit(0)});
